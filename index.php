    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
         <img src="assets/img/logo_icon.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            ...
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
              ...
              <h4 class="title"><a href="">Object Recognition System</a></h4>
              <p class="description">To create an object recognition system that will determine and differentiate Korean food products.</p>
            </div>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
              <div class="icon"><i class='bx bx-calculator' ></i></div>
              <h4 class="title"><a href="">Real-Time Calculation & Pricing Integration</a></h4>
              <p class="description">To calculate in real-time and integrate the pricing of the Korean foods based on the vendor preference.</p>
            </div>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
              <div class="icon"><i class='bx bx-objects-vertical-bottom'></i></div>
              <h4 class="title"><a href="">Effeciency</a></h4>
              <p class="description">To develop additional features—an inventory system for the efficiency of tracking the stocks and sales. </p>
            </div>
